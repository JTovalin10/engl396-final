export default function Setup() {
  return (
    <article className="endpoint-card" id="setup">
      ...
      <ol>
        <li>Download and install R from <a href="https://cran.r-project.org/">CRAN</a>. Select your operating system, download the latest release, and follow the installer prompts.</li>
