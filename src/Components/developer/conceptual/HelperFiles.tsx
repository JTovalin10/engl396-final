export default function HelperFiles() {
  return (
    <article className="endpoint-card">
      ...
      <p><strong><code>compare_bands.R</code></strong> — Takes two artist selections and produces a comparative line chart. Each artist's average rating per year is plotted as a line — red for the first artist, blue for the second.</p>
