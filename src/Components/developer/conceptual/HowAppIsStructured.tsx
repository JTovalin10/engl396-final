  ...
  return (
    <article className="endpoint-card">
      ...
      <ol>
        ...
        <li><strong>Server layer:</strong> <code>app_server.R</code> listens for user input and calls the appropriate helper function. When a user changes a drop-down or slider, Shiny automatically re-runs the relevant block of server code. This behavior is called <strong>reactivity</strong>.</li>
      </ol>
