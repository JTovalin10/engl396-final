    ...
    <article className="endpoint-card">
      ...
      <ol>
        <li>Click the <strong>Top Albums by Year</strong> tab.
          <img src={import.meta.env.BASE_URL + "task/TopAlbumsByYear/S1.jpg"} alt="Top Albums by Year tab showing the Choose a year drop-down menu and a Submit button" className="step-img" />
        </li>
        <li>Click the <strong>Choose a year</strong> <em>drop-down menu</em>.
          <img src={import.meta.env.BASE_URL + "task/TopAlbumsByYear/S2.jpg"} alt="Drop-down menu open with a list of years to select from" className="step-img" />
        </li>
        <li>Select a year. For this tutorial, select <strong>1995</strong>.
          <img src={import.meta.env.BASE_URL + "task/TopAlbumsByYear/S3.jpg"} alt="Data table displaying ranked albums for 1995 with (What's the Story) Morning Glory? listed as the number one album" className="step-img" />
        </li>
        <li>Click <strong>Submit</strong>. If done correctly, the number one album for 1995 is <em>(What's the Story) Morning Glory?</em>, as shown below.
          <img src={import.meta.env.BASE_URL + "task/TopAlbumsByYear/S4.jpg"} alt="Completed Top Albums by Year data table showing full results for 1995" className="step-img" />
        </li>
      </ol>
