    ...
    <article className="endpoint-card">
      ...
      <ol>
        <li>Click the <strong>Artist's Albums</strong> tab.
          <img src={import.meta.env.BASE_URL + "task/ArtistsAlbums/S1.jpg"} alt="Artist's Albums tab showing the Choose a band or artist drop-down menu and a Submit button" className="step-img" />
        </li>
        <li>Click the <strong>Choose a band or artist</strong> <em>drop-down menu</em> and select <strong>10,000 Maniacs</strong>.
          <img src={import.meta.env.BASE_URL + "task/ArtistsAlbums/S2.jpg"} alt="Drop-down menu open showing a list of artists in alphabetical order" className="step-img" />
        </li>
        <li>Click <strong>Submit</strong>. If done correctly, 10,000 Maniacs has one ranked album, <em>MTV Unplugged</em>. Below the table, the total album count and average rating are displayed, as shown below.
          <img src={import.meta.env.BASE_URL + "task/ArtistsAlbums/S3.jpg"} alt="Data table showing 10,000 Maniacs with one ranked album MTV Unplugged and the album count and average rating displayed below" className="step-img" />
      ...
      <img src={import.meta.env.BASE_URL + "task/ArtistsAlbums/S4.jpg"} alt="Data table automatically updating to show A.C. Newman's ranked album The Slow Wonder" className="step-img" />
    </article>
  )
}
