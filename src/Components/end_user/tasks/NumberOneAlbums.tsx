    ...
    <article className="endpoint-card">
      ...
      <ol>
        <li>Click the <strong>Number One Albums</strong> tab. A <em>range slider</em> and 6 albums in a <em>data table</em> appear like the image below (the range slider is set from 1993 to 1998 at the beginning).
          <img src={import.meta.env.BASE_URL + "task/NumberOneAlbums/S1.jpg"} alt="Number One Albums tab showing a range slider set from 1993 to 1998 and a data table with 6 albums" className="step-img" />
        </li>
        <li>Drag your mouse over the right <em>handle</em> and slide it to 2010. If done correctly, the last album in the <em>data table</em> has the year 2010, as shown below.
          <img src={import.meta.env.BASE_URL + "task/NumberOneAlbums/S2.jpg"} alt="Range slider with right handle moved to 2010, data table showing last entry as year 2010" className="step-img" />
        </li>
        <li>Drag your mouse over the left <em>handle</em> and slide it to 2000. If done correctly, the first album in the <em>data table</em> contains the year 2000 or later, as shown below.
          <img src={import.meta.env.BASE_URL + "task/NumberOneAlbums/S3.jpg"} alt="Range slider with left handle moved to 2000, data table showing first entry as year 2000 or later" className="step-img" />
        </li>
      </ol>
    </article>
  )
