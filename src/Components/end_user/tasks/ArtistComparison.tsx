    ...
    <article className="endpoint-card">
      ...
      <ol>
        <li>Click the <strong>Artist Comparison</strong> tab.
          <img src={import.meta.env.BASE_URL + "task/ArtistComparison/S1.jpg"} alt="Artist Comparison tab showing two drop-down menus for selecting a first and second artist" className="step-img" />
        </li>
        <li>Click the <strong>First band or artist</strong> <em>drop-down menu</em> and select your first artist.
          <img src={import.meta.env.BASE_URL + "task/ArtistComparison/S2.png"} alt="First band or artist drop-down menu open with a list of artists to select from" className="step-img" />
        </li>
        <li>Click the <strong>Second band or artist</strong> <em>drop-down menu</em>.
          <ol className="sub-steps">
            <li>Select <strong>Acid House Kings</strong>. The chart generates automatically with no Submit button needed. If done correctly, the chart looks like the one shown below.</li>
          </ol>
          <img src={import.meta.env.BASE_URL + "task/ArtistComparison/S3.jpg"} alt="Completed comparative line chart with two colored lines plotted by year and rating" className="step-img" />
