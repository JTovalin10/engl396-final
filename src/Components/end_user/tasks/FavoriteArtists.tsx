    ...
    <article className="endpoint-card">
      ...
      <ol>
        <li>Click the <strong>Favorite Artists</strong> tab.
          <img src="/task/FavoriteArtists/S1.jpg" alt="Favorite Artists tab showing the Minimum number of albums drop-down menu, the Exclude EPs and Live Albums checkbox, and a Submit button" className="step-img" />
        </li>
        <li>Click <strong>Submit</strong>. The default setting requires a minimum of 10 albums and does not exclude EPs or Live Albums. If done correctly, 6 artists appear in the <em>data table</em>, as shown below.
          <img src="/task/FavoriteArtists/S2.jpg" alt="Data table showing 6 artists with the default minimum of 10 albums and EPs and Live Albums not excluded" className="step-img" />
        ...
        <li>Click the <strong>Exclude EPs and Live Albums</strong> checkbox. You do not need to click Submit again. The app automatically refreshes the results. If done correctly, 7 artists now appear, as shown below.
          <img src="/task/FavoriteArtists/S3.jpg" alt="Data table refreshed to show 7 artists after checking the Exclude EPs and Live Albums checkbox" className="step-img" />
        </li>
        <li>Click the <strong>Minimum number of albums</strong> <em>drop-down menu</em>.
          <img src="/task/FavoriteArtists/S4.jpg" alt="Minimum number of albums drop-down menu open showing numeric options" className="step-img" />
      ...
      <img src="/task/FavoriteArtists/S5.jpg" alt="Data table showing 10 artists after selecting a minimum of 8 albums with EPs and Live Albums included" className="step-img" />
    </article>
  )
}
