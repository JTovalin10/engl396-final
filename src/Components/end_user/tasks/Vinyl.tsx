    ...
    <article className="endpoint-card">
      ...
      <ol>
        ...
        <li>Click the <strong>Select which albums to display</strong> <em>drop-down menu</em>.
          <img src="/task/Vinyl/S2.jpg" alt="Drop-down menu open showing minimum rating threshold options" className="step-img" />
          <ol className="sub-steps">
            <li>Select <strong>9 and higher</strong>.
              <img src="/task/Vinyl/S3.jpg" alt="Data table listing albums rated 9 and above not yet owned on vinyl, with Album, Artist, and Rating columns" className="step-img" />
            </li>
            <li>Click <strong>Submit</strong>. If done correctly, only albums rated 9 and above appear, as shown below.
              <img src="/task/Vinyl/S4.jpg" alt="Completed Vinyl data table showing full results for the selected minimum rating" className="step-img" />
            </li>
          </ol>
        </li>
      </ol>
