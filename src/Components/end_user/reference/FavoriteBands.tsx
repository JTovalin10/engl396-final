  ...
  return (
    <section className="endpoint-section">
      ...
      <article className="endpoint-card">
        ...
        <p>Returns up to 15 artists with at least <code>min_albums.var</code> ranked albums, sorted by average rating in descending order. When <code>live_ep.var == TRUE</code>, EPs and live albums are excluded before the count and rating are calculated.</p>
