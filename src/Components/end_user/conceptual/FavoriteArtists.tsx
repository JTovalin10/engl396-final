export default function FavoriteArtists() {
  return (
    <article className="endpoint-card">
      ...
      <img src={import.meta.env.BASE_URL + "conceptual/Artists with Highly Rated Albums.png"} alt="Favorite Artists tab showing the filter controls and top-rated artists table" className="step-img" />
    </article>
  )
}
