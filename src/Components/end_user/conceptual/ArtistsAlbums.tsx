export default function ArtistsAlbums() {
  return (
    <article className="endpoint-card">
      ...
      <img src={import.meta.env.BASE_URL + "conceptual/About an Artist's Albums.png"} alt="Artist's Albums tab showing the artist drop-down and album data table with rating summary" className="step-img" />
    </article>
  )
}
