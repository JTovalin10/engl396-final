export default function ArtistComparison() {
  return (
    <article className="endpoint-card">
      ...
      <img src="/conceptual/Compare Two Artists on the Graphs.png" alt="Artist Comparison tab showing a line chart comparing two artists' ratings over time" className="step-img" />
    </article>
  )
}
