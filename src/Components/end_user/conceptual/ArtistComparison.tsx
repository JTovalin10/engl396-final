export default function ArtistComparison() {
  return (
    <article className="endpoint-card">
      ...
      <img src={import.meta.env.BASE_URL + "conceptual/artist-comparison.png"} alt="Artist Comparison tab showing a line chart comparing two artists' ratings over time" className="step-img" />
    </article>
  )
}
