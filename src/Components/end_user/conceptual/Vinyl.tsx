export default function Vinyl() {
  return (
    <article className="endpoint-card">
      ...
      <img src="/conceptual/Top-Rated Albums Not Owned on Vinyl.png" alt="Vinyl tab showing the rating filter and table of albums not yet owned on vinyl" className="step-img" />
    </article>
  )
}
