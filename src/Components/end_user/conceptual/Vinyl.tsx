export default function Vinyl() {
  return (
    <article className="endpoint-card">
      ...
      <img src={import.meta.env.BASE_URL + "conceptual/vinyl.png"} alt="Vinyl tab showing the rating filter and table of albums not yet owned on vinyl" className="step-img" />
    </article>
  )
}
